...
namespace ImpulsaDBA.Client.Auth
{
    /// <summary>
    ...
    public class CustomAuthStateProvider : AuthenticationStateProvider
    {
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            try
            {
                ...
                var sesion = System.Text.Json.JsonSerializer.Deserialize<SesionUsuarioResponse>(sesionJson);
        ...
        public async Task GuardarSesionAsync(SesionUsuarioResponse sesion)
        {
            try
            {
