...
namespace ImpulsaDBA.Services
{
    ...
    public class AuthService
    {
        ...
        public async Task<Usuario?> ValidarCredencialesUsuario(string? correo, string? cedula, string? numeroCelular)
        {
            try
            {
        ...
        /// <returns>Usuario si la contraseña es válida, null en caso contrario</returns>
        public async Task<Usuario?> ValidarCredencialesPassword(string password, int? usuarioId = null)
        {
            try
            {
        ...
        /// <returns>Usuario si las credenciales son válidas, null en caso contrario</returns>
        public async Task<Usuario?> ValidarLoginCompleto(string usuario, string password)
        {
            try
            {
                ...
                // Retornar el usuario con datos completos (incluye rol actualizado)
